...
<div className='w-[258px] h-[19px] text-[16px] sm:w-[440px] md:w-[440px] md:h-[32px] font-bold sm:text-[27px] text-center text-[#11151D]'>FREQUENTLY ASKED QUESTION</div>
<div className='w-[261px] h-[34px] sm:w-[619px] sm:h-[44px] font-medium text-[14px] sm:text-[18px] text-center'>
Quick answers to questions you may have. Can’t find what you're looking for ?  
<span className='text-[#4A508E] hidden md:block'>
