    ...
    <div className="flex-grow flex-shrink-0 flex flex-col justify-center items-center gap-4 md:gap-[50px]">
        <div className="flex flex-col justify-center items-center gap-4 md:gap-[50px] w-full md:h-[540px]">
            <div className="flex flex-col justify-start items-center gap-2 md:gap-[15px] text-center">
                <div className="text-gray-50 text-[24px] md:text-[40px] font-bold font-['Urbanist']">Your audience wants links</div>
                <div className="text-gray-50 text-[16px] md:text-lg font-medium font-['Urbanist']">Make it easy for them by linking products to every post and video</div>
            </div>
            ...
            <img className="w-[320px] md:w-[720px] h-auto md:h-[405px] rounded-[35px] shadow" src="/assets/Link.png" alt="Sample" />
        </div>
